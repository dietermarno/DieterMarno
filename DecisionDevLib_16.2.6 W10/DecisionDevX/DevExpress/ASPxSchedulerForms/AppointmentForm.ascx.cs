...
public partial class AppointmentForm : SchedulerFormControl {
    ...
    void Localize() {
        ...
        lblLabel.Text = "Origem:"; //ASPxSchedulerLocalizer.GetString(ASPxSchedulerStringId.Form_Label);
        lblStartDate.Text = "Início:"; //ASPxSchedulerLocalizer.GetString(ASPxSchedulerStringId.Form_StartTime);
        lblEndDate.Text = ASPxSchedulerLocalizer.GetString(ASPxSchedulerStringId.Form_EndTime);
        lblStatus.Text = "Situação:"; //ASPxSchedulerLocalizer.GetString(ASPxSchedulerStringId.Form_Status);
        lblAllDay.Text = ASPxSchedulerLocalizer.GetString(ASPxSchedulerStringId.Form_AllDayEvent);
        lblResource.Text = "Promotor:"; //ASPxSchedulerLocalizer.GetString(ASPxSchedulerStringId.Form_Resource);
        if (CanShowReminders)
