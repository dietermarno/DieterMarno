<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="oportunidades_boasvindas_email.aspx.cs" Inherits="Decision.oportunidades_boasvindas_email" %>
            ...
            <table style="width: 800px; border: 1px solid #808080; border-top: 0px solid;">
                <tr>
                    <td style="width: 100%; padding: 15px;">
                        ...
                        <br />
                        <br />
                        Sua solicitação foi recebida e já está sendo processada por nosso atendimento.
                        <br />
                        <br />
