...
namespace Decision.TableManager
{
    ...
    public class Requisicao_Manager
    {
        ...
        public DataRow[] GetReqsFromProcess(Int32 NroProcess)
        {
            //**************
            //* Declarações 
            //**************
            ...
            try
            {
                ...
                //* Obtem registro 
                //*****************
                SQL = "SELECT NroRequis FROM requisicao WHERE NroProcesso = " + NroProcess.ToString();
                oTable = oDBManager.ExecuteQuery(SQL);
